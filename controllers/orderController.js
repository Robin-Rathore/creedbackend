...
const { calculatePagination, generateOrderNumber, calculateTax, calculateShippingCost } = require("../utils/helpers")
...
const getAllOrders = async (req, res) => {
  try {
    const { page = 1, limit = 20, status, paymentStatus, dateFrom, dateTo, search } = req.query
