...
/**
 * @route   PUT /api/v1/users/cart/:itemId
...
/**
 * @route   DELETE /api/v1/users/cart/:itemId
 ...
 * @access  Private
 */
router.post("/wishlist/:productId", protect, validateObjectId("productId"), addToWishlist)
 ...
 * @access  Private
 */
router.delete("/wishlist/:productId", protect, validateObjectId("productId"), removeFromWishlist)
...
/**
 * @route   GET /api/v1/users/orders/:orderId
 * @desc    Get single order
 * @access  Private
 */
router.get("/orders/:orderId", protect, validateObjectId("orderId"), getUserOrder)
