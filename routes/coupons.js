 ...
 * @access  Private (Admin)
 */
router.put("/:id", protect, restrictTo("admin"), validateObjectId(), updateCoupon)
 ...
 * @access  Private (Admin)
 */
router.delete("/:id", protect, restrictTo("admin"), validateObjectId(), deleteCoupon)
 ...
 * @access  Private (Admin)
 */
router.get("/:id/stats", protect, restrictTo("admin"), validateObjectId(), getCouponStats)
